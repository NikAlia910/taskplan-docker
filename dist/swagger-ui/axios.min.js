...
!(function (e, t) {
        ...
        if (!he.isUndefined(r)) {
          ...
          l.push(r),
            he.forEach(r, function (r, i) {
              !0 === (!(he.isUndefined(r) || null === r) && o.call(t, r, he.isString(i) ? i.trim() : i, n, p)) &&
                e(r, n ? n.concat(i) : [i]);
            }),
            l.pop();
        }
  ...
  function He(e, t, r, n, o) {
    return he.isFunction(n)
      ? n.call(this, t, r)
      : (o && (t = r), he.isString(t) ? (he.isString(n) ? -1 !== t.indexOf(n) : he.isRegExp(n) ? n.test(t) : void 0) : void 0);
  }
  var Je = (function (e, t) {
    function r(e) {
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 33:
                      if (
                        ((e.prev = 33), (e.t2 = e.catch(4)), E && E(), !e.t2 || 'TypeError' !== e.t2.name || !/fetch/i.test(e.t2.message))
                      ) {
                        e.next = 38;
                        break;
                      }
  ...
  var kt = function (e) {
    ...
    jt = function (e) {
      for (var t, r, n = (e = he.isArray(e) ? e : [e]).length, o = {}, i = 0; i < n; i++) {
        var a = void 0;
        if (((r = t = e[i]), !Tt(t) && void 0 === (r = Rt[(a = String(t)).toLowerCase()])))
        ...
        function (t) {
          return (
            Ve(t) ||
              ...
              t &&
                t.response &&
                ((t.response.data = Ke.call(e, e.transformResponse, t.response)), (t.response.headers = We.from(t.response.headers)))),
            Promise.reject(t)
          );
        },
      )
  ...
  (Nt.transitional = function (e, t, r) {
    ...
    return function (r, o, i) {
      ...
      return (
        t && !_t[o] && ((_t[o] = !0), console.warn(n(o, ' has been deprecated since v' + t + ' and will be removed in the near future'))),
        !e || e(r, o, i)
      );
    };
  }),
              ...
              void 0 !== n &&
                ...
                null != o &&
                  (he.isFunction(o)
                    ...
                    : Ct.assertOptions(o, { encode: Ut.function, serialize: Ut.function }, !0)),
                void 0 !== t.allowAbsoluteUrls ||
                  (void 0 !== this.defaults.allowAbsoluteUrls
                    ? (t.allowAbsoluteUrls = this.defaults.allowAbsoluteUrls)
                    : (t.allowAbsoluteUrls = !0)),
                Ct.assertOptions(t, { baseUrl: Ut.spelling('baseURL'), withXsrfToken: Ut.spelling('withXSRFToken') }, !0),
                (t.method = (t.method || this.defaults.method || 'get').toLowerCase());
              var a = i && he.merge(i.common, i[t.method]);
              i &&
                he.forEach(['delete', 'get', 'head', 'post', 'put', 'patch', 'common'], function (e) {
                  delete i[e];
                }),
    ...
    he.forEach(['post', 'put', 'patch'], function (e) {
      function t(t) {
        return function (r, n, o) {
          return this.request(it(o || {}, { method: e, headers: t ? { 'Content-Type': 'multipart/form-data' } : {}, url: r, data: n }));
        };
      }
